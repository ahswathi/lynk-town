...
let Header = () => {
    ...
    return (
        <>
            <div className="header-wrapper box-border	 block h-[280px] lg:h-[524px] md:h-[440px] sm:h-[420px]  sm:mb-[180px] md:mb-[180px]  ">
                <div className="h-[320px] lg:h-[724px] md:h-[540px] sm:h-[420px] bg-[#6A5B40]">
                    ...
                    <div className="flex justify-around  z-0 my-[30px] sm:my-[60px] md:my-[60px] lg:my-[80px] mx-[50px] sm:mx-[100px] lg:mx-[120px] gap-8 sm:gap-14 lg:gap-34">
