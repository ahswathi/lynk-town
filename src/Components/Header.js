            ...
            <div className="header-wrapper  ">
                <div className="max-h-[210px] lg:max-h-[724px] sm:max-h-[420px] bg-[#6A5B40]">
                    ...
                    <div className="header">
                        <p className="title pt-2 lg:text-[52px] sm:text-[32px] text-[12px] text-center text-white">Create an order
                    ...
                    <div className="flex justify-around mt-[40px] z-0 sm:mt-[60px] md:mt-[60px]   sm:mt-[60px] lg:mt-[80px] mx-[50px] sm:mx-[100px] lg:mx-[120px] gap-8 sm:gap-14 lg:gap-34">
